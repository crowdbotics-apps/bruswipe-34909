  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_96_7}>
        ...
        <TouchableOpacity
          style={styles.TouchableOpacity_96_10}
          onPress={() =>
        ...
        <ImageBackground
          ...
          style={styles.ImageBackground_96_12}
        />
        <View style={styles.View_96_13}>
          <Text style={styles.Text_96_13}>Total asset</Text>
        </View>
        <View style={styles.View_96_14}>
          <Text style={styles.Text_96_14}>BND $0.00</Text>
        </View>
        <TouchableOpacity
          style={styles.TouchableOpacity_96_15}
          onPress={() =>
            this.props.navigation.navigate(getNavigationScreen("83_14"))
          }
        >
          <Text style={styles.Text_96_15}>Transaction History</Text>
        </TouchableOpacity>
        <View style={styles.View_96_16}>
          <Text style={styles.Text_96_16}>LogOut</Text>
        </View>
        <ImageBackground
          source={{
            uri:
        ...
        <TouchableOpacity
          ...
          style={styles.TouchableOpacity_96_19}
          onPress={() =>
        ...
        <View style={styles.View_96_21}>
          <Text style={styles.Text_96_21}>BruSwipe</Text>
        </View>
        <View style={styles.View_96_22}>
          <Text style={styles.Text_96_22}>Top up</Text>
        </View>
        <View style={styles.View_96_23}>
          <Text style={styles.Text_96_23}>Transfer</Text>
        </View>
        <View style={styles.View_96_24}>
          <Text style={styles.Text_96_24}>Reward Point</Text>
        </View>
        <TouchableOpacity
          source={{
            uri:
          ...
          style={styles.TouchableOpacity_96_25}
          onPress={() =>
            this.props.navigation.navigate(getNavigationScreen("4_49"))
          }
        />
        <View style={styles.View_96_26}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/c78c/13e2/1b64c5ef497eaf893dc86020deb63d02"
            }}
            style={styles.ImageBackground_96_27}
          />
        </View>
        <View style={styles.View_96_30}>
          <Text style={styles.Text_96_30}>Welcome Back</Text>
        </View>
      </View>
    </ScrollView>
  )
